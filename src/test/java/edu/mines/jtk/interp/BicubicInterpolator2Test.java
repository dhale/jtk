...
/**
 * Tests {@link edu.mines.jtk.interp.BicubicInterpolator2}.
...
public class BicubicInterpolator2Test extends TestCase {
  ...
  public void testSingleValues() {
    ...
    BicubicInterpolator2 bi = makeInterpolator(x1,x2,y);
    int n = 101;
  ...
  private static BicubicInterpolator2 makeInterpolator(
    float[] x1, float[] x2, float[][] y)
  {
    return new BicubicInterpolator2(
      BicubicInterpolator2.Method.MONOTONIC,
      BicubicInterpolator2.Method.MONOTONIC,
      x1.length,x2.length,x1,x2,y);
  }
