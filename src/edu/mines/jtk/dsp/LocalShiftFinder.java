...
public class LocalShiftFinder {
  ...
  ///////////////////////////////////////////////////////////////////////////
  // These methods for spectral whitening are no longer used. They assumed 
  // incorrectly that symmetric local correlation filters were necessary 
  // to compute local prediction filters.

  private LocalCorrelationFilter _lcfSymmetric; // currently unused
   ...
   * @param g the output array.
   */
  private void xwhiten(double sigma, float[][] f, float[][] g) {
    int n1 = f[0].length;
    int n2 = f.length;
    float[][] r00 = new float[n2][n1];
    float[][] rpm = new float[n2][n1];
