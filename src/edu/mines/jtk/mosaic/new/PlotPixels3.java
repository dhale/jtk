...
/**
 * A plot panel with three pixels views to display a 3-D array.
 * @author Dave Hale, Colorado School of Mines
 * @version 2007.04.20
 */
public class PlotPixels3 extends PlotPanel {
  private static final long serialVersionUID = 1L;

  /**
   * Constructs a plot panel with three pixels view
    ...
    Orientation orientation) 
  {
    ...
    _k2 = _n2/2;
    _k3 = _n3/2;
    _p12 = panel.addPixels(1,0,s1,s2,slice12())
    _p13 = panel.addPixels(1,1,s1,s3,slice13())
    _p23 = panel.addPixels(0,0,s2,s3,slice23())
  }

  public int getSlice1(int k1) {
    setSlices(k1,_k2,_k3);
  }

  public int getSlice2(int k2) {
    setSlices(_k1,k2,_k3);
  }

  public int getSlice3(int k3) {
  ...
  public void setSlices(int k1, int k2, int k3) {
    if (_k1!=k1) {
      _k1 = k1;
      _p23.set(_s2,_s3,slice(_k1));
    }
    if (_k2!=k2) {
      _k2 = k2;
      _p13.set(_s1,_s3,slice(_k2));
    }
    if (_k3!=k3) {
      _k3 = k3;
      _p12.set(_s1,_s2,slice(_k3));
    }
  }
  ...
  /**
   * Sets the clips for this panel. Pixels views in this panel map array 
  ...
  private float[][] slice12() {
    float[][] x = new float[_n2][_n1];
    _f3.get12(_n1,_n2,0,0,_k3,x);
    return x;
  }
  private float[][] slice13() {
    float[][] x = new float[_n3][_n1];
    _f3.get13(_n1,_n3,0,_k2,0,x);
    return x;
  }
  private float[][] slice23() {
    float[][] x = new float[_n3][_n2];
    _f3.get23(_n2,_n3,_k1,0,0,x);
    return x;
  }
