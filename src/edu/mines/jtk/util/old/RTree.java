...
public class RTree extends AbstractSet {
  ...
  private class Node {
     ...
     */
    void remove(Object box, ArrayList orphans) {
     ...
     */
    void findOverlapping(float[] min, float[] max, ArrayList list) {
     ...
     */
    void findInSphere(float[] center, float radius, ArrayList list) {
    ...
    void findNearest(Nearest nearest) {
      ...
      // Else, if this node is not a leaf node, ...
        ...
        ArrayList list = new ArrayList(_nbox);
        for (int ibox=0; ibox<_nbox; ++ibox) {
   ...
   */
  private static class BoxDistance implements Comparable {
    Object box;
    float distance;
    ...
    public int compareTo(Object object) {
      BoxDistance bd = (BoxDistance)object;
