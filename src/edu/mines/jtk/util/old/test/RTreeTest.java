...
import com.lgc.idh.util.RTree;
import com.lgc.idh.util.Stopwatch;

/**
 * Tests {@link com.lgc.idh.mesh.RTree}.
 * @author Dave Hale
 * @version 2003.05.02
 */
public class RTreeTest extends TestCase {
  ...
  */
  ...
  private Point pointOnSurface(int isurf, float x, float y) {
    float z = 0.1f+(float)isurf*0.1f+0.05f*M.sin(20.0f*x+20.0f*y);
  ...
  public RTreeTest(String name) {
    super(name);
  }

  public static Test suite() {
    return new TestSuite(RTreeTest.class);
  }
