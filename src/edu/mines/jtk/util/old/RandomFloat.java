...
public class RandomFloat {
  ...
  /**
   * Construct a generator.
   *@param seed Seed with which to initialize the generator.
   */
  ...
  /**
   * Get a pseudo-random float from a uniform distribution 
  ...
  /**
   * Get a pseudo-random float from a normal (Gaussian)
   * distribution with zero mean and unit variance; i.e., from N(0,1).
   *@return The pseudo-random float.
   */
  public float normal() {
   ...
   *@param seed Different seeds yield different sequences of random numbers.
   */
