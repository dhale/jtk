 ...
 * primitive values one a time; e.g., {@link java.io.DataInput#readFloat()}.
 * Similar methods are specified for writing primitive values one at a time.
 * When reading or writing arrays of primitive values, calling those methods 
