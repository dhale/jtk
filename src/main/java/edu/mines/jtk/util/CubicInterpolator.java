 ...
 * compute slopes y'(x) at specified x (knots). The classic cubic spline 
 * computes the slopes to obtain a continuous second derivative at the knots.
...
public class CubicInterpolator {
   ...
   * <p>
   * If linear, then the interpolated function is continuous, but has 
   * discontinuous 1st and higher derivatives. This method is equivalent 
   * to (though less efficient than) simple linear interpolation.
   * <p>
   * If monotonic, then the interpolation is continuous with continuous 
   * 1st derivative, but discontinuous 2nd and higher derivatives. This 
   * method preserves monotonicity. If function values specified at the 
   * knots are monotonic, then interpolated function values are also 
   * monotonic.
   * <p>
   * If spline, then the interpolation is continuous with continuous 
   * 1st and 2nd derivatives, but discontinuous 3rd and higher and 
   * discontinuous higher order derivatives.
   */
  public enum Method {
    LINEAR,
    MONOTONIC,
